...
@HiltViewModel
class SignUpViewModel @Inject constructor(val firebaseAuthInteractor: FirebaseAuthInteractor) : ViewModel() {
    ...
    fun signUpIntent() {
        ...
        viewModelScope.launch {
            val authResult = firebaseAuthInteractor.doSignUp(_email.value, _password.value, _username.value)
            authResult?.let {
